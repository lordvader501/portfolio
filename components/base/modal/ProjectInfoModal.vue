<template lang="">
  <div class="modal-container" :class="{ active: activeModal }">
    ...
    <section class="testimonials-modal block overflow-auto scrollbar-hide" style="max-height: -webkit-fill-available;">
      ...
      <div class="modal-content space-y-3 mt-4">
        <div class="flex justify-between items-center">
          ...
          <div class="flex gap-6 text-sm">
            <NuxtLink :to="activeItem.gh_url" target="_blank" class="flex items-center gap-1 text-white">
              <ion-icon name="logo-github" />
              Github
            </NuxtLink>
            <NuxtLink v-if="activeItem.live_url" :to="activeItem.live_url" target="_blank" class="flex items-center gap-1 text-white">
        ...
        <div class="flex flex-wrap items-center justify-start">
          <span class="text-white mr-3 text-lg">Tech Stack: </span>
